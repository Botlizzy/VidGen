  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (signup) {
        ...
        setSubmitted(true);
        setMessage("Check your inbox to verify your email address before signing in.");
      } else {
